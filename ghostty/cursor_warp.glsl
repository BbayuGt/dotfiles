...
// --- CONFIGURATION ---
vec4 TRAIL_END_COLOR = vec4(0.541, 0.471, 0.639, 1.0); // for custom color: vec4(0.2, 0.6, 1.0, 0.5); (wrap in sRGBToLinear for correct brightness)
vec4 TRAIL_START_COLOR = vec4(0.886, 0.867, 0.925, 1.0);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord){
    ...
    if (lineLength > minDist && baseProgress < DURATION - 0.001) {
        ...
        vec4 trail = mix(TRAIL_START_COLOR, TRAIL_END_COLOR, fadeProgress);
