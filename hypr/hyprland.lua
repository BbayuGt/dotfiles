...
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("ghostty -e hyprmode"))
...
hl.bind(mainMod .. " + SHIFT_R", hl.dsp.window.fullscreen({ mode = "maximized", action = "toggle"}))
